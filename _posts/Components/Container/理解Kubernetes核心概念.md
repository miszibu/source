...
date: 2018-12-11 09:23:36
tags: [容器]
---

> 作为一个后端开发，Kubernetes已经是常常被提到的事情，目前还未涉及到这方面的知识，但是我们先来认识和了解下Kubernetes的核心概念。
>
> 本文转载自[十分钟带你理解Kubernetes核心概念](http://dockone.io/article/932)
...
![](理解Kubernetes核心概念/d56441427680948fb56a00af57bda690.png)

上图可以看到如下组件，使用特别的图标表示Service和Label：

- Pod
- Container（容器）
- Label(![label](理解Kubernetes核心概念/label.png))（标签）
- Replication Controller（复制控制器）
- Service（![enter image description here](理解Kubernetes核心概念/service.png)）（服务）
- Node（节点）
...
![](理解Kubernetes核心概念/5e2bad1a25e33e2d155da81da1d3a54b.gif)
...
![](理解Kubernetes核心概念/125bbccce0b3bbf42abab0e520d9250b.gif)
